    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#232323] via-[#2B2B2B] to-[#383838] px-8 py-7">
      <div className="flex items-center justify-between">
        <div className="max-w-lg">
          <h2 className="text-[28px] font-serif font-semibold text-[#D8D2CC]">
            Service Preparedness
          </h2>

          <p className="mt-3 text-[15px] leading-7 text-[#8E8E8E]">
            The kitchen has been notified of 4 high-priority dietary
            requirements for this evening's service.
          </p>
        </div>

        <div className="relative flex h-[95px] w-[95px] shrink-0 items-center justify-center rounded-full border-[3px] border-[#4F4F4F]">
          <div className="absolute inset-0 rounded-full bg-white/5 blur-md" />

          <span className="relative text-[30px] font-bold text-[#CFCFCF]">
            85%
          </span> 
        </div>
      </div>
